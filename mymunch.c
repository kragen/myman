...
#define MAZEFILE "munchkin.txt"
#define WIDTH 27
#define HEIGHT 15
#define DOTS 91
#define DOTS_FRUIT1 31
#define DOTS_FRUIT2 61
#define MSGLEN 7
...
#define YSTART (19 * TILEHEIGHT / 2)
#define XFRUIT XSTART
#define YFRUIT (15 * TILEHEIGHT / 2)
#define YGHOST YFRUIT
#define YTOP (YFRUIT - 2 * TILEHEIGHT)
#define PAUSE "-PAUSED-"
