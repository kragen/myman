...
#define MAZEFILE "pac-gal.txt"
#define WIDTH 40
#define HEIGHT 24
#define DOTS 468
#define DOTS_FRUIT1 100
#define DOTS_FRUIT2 200
#define MSGLEN 10
...
#define YSTART (37 * TILEHEIGHT / 2)
#define XFRUIT XSTART
#define YFRUIT (33 * TILEHEIGHT / 2)
#define YGHOST (YFRUIT - 3 * TILEHEIGHT)
#define YTOP (YFRUIT - 6 * TILEHEIGHT)
#define PAUSE " - PAUSED - "
